    ...
    <MainLayout>
        <div v-if="loaded">
            ...
            <div class="card mb-25 border-0 rounded-0 bg-white letter-spacing mt-4">
                <div
                    ...
                    <div class="d-flex align-items-center">
                        <form v-if="false" class="search-box position-relative me-15" @submit.prevent="">
                        ...
                        <button
                            ...
                            @click="initialize()" data-bs-toggle="modal" data-bs-target="#basicModal" style="
            ...
            <div class="row" v-if="users && users.length > 0">
                <div class="col-sm-6 col-lg-4 col-xxxl-3" v-for="(user, index) in users" :key="index">
                    <div class="card mb-25 border-0 rounded-0 bg-white seller-card">
                        <div class="card-body letter-spacing">
                            <div class="mb-15 mb-md-20 mb-lg-25 d-flex align-items-center justify-content-between">
                                <div class="icon position-relative text-center rounded-circle" style="overflow: hidden">
                                    <img :src="user.image"
                                    ...
                                    <ul class="dropdown-menu">
                                        <li>
                                            <button class="dropdown-item d-flex align-items-center"
                                                @click.prevent="setUser(user)" data-bs-toggle="modal"
                                        ...
                                        <li>
                                            <button class="dropdown-item d-flex align-items-center" @click.prevent="
                                                deleteUser(user)
                                                ">
                            ...
                            <ul class="list mt-15 mt-lg-25 ps-0 mb-0 list-unstyled d-flex justify-content-between">
                                <li>
                                    <span
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h1 v-else class="modal-title fs-5" id="addNiveauLabel">
                        ...
                        <div class="modal-body">
                            <div class="row">
                                <div class="col">
                                    <div class="mb-mb-15 mb-md-20">
                                        <label for="inputTitle" class="form-label fw-medium">Nom et prénom</label>
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="mb-mb-15 mb-md-20">
                                        <label for="inputTitle" class="form-label fw-medium">Tél</label>
                                        <input v-model="user.tel" type="text"
                                            class="form-control shadow-none text-black fs-md-15 fs-lg-16"
                                            id="inputTitle" aria-describedby="TitleHelp" placeholder="tél" />
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="mb-mb-15 mb-md-20">
                                        <label for="inputTitle" class="form-label fw-medium">Email</label>
                                        <input v-model="user.email" type="text"
                                            class="form-control shadow-none text-black fs-md-15 fs-lg-16"
                                            id="inputTitle" aria-describedby="TitleHelp" placeholder="email" />
                                    </div>
                                </div>
                            </div>
                            <div class="mb-mb-15 mb-md-20">
                                <label for="inputTitle" class="form-label fw-medium">Role</label>
                                <VueMultiselect v-model="user.role" :options="roles" :multiple="false"
                                    :close-on-select="true" placeholder="Choisissez le role" label="Label" value="id"
                                    track-by="id">
                                </VueMultiselect>
                            </div>
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="mb-mb-15 mb-md-20">
                                        <label for="inputTitle" class="form-label fw-medium">Status (activer ou
                                            désactiver )</label>
                                        <v-switch inset color="success" label="Active" v-model="user.active"></v-switch>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="mb-mb-15 mb-md-20 mt-2">
                                <div class="file-upload text-center position-relative">
                                    <div class="user-img-clips">
                                        ...
                                        <img width="150px" :src="imageUrl" alt="Uploaded Image" class="preview-image" />
                                    </div>
                        ...
                        <div class="modal-footer">
                            ...
                            <button v-if="isEdit" type="button" @click="updateUser()" class="btn btn-primary">
                                Modifier
                            </button>
                            <button v-else type="button" @click="saveUser()" class="btn btn-primary">
                                Enregistrer
                            </button>
                        </div>
                    </div>
