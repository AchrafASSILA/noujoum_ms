    ...
    <tbody>
        <tr align="center">
            ...
            <td width="60%" align="left">
                ...
                <br>
                <br>
                <span class="information-title" style="height:20%">Année : <span class="val" style="text-align: left;"><?php echo $client->inscription()->promotion->Year ?></span></span>
                <br>
                <br>
                <span class="information-title" style="height:20%">Modules : <span class="val" style="text-align: left;">
                        <?php
                        foreach ($client->getModules() as $key => $module) {
